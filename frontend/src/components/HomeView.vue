...
<template>
  <main class="main flex justify-center items-center h-auto w-full">
    ...
    >
      ...
      <div id="top" class="text-[30px] mt-[20px] font-light">
        Brandcraft.art
      </div>
      <h1
      ...
      <div v-if="!success" class="h-[140px]">
        ...
        <form @submit.prevent="handleSubmit" class="mb-4 w-[350px]">
          ...
          <input
            ...
            class="w-full p-2 border rounded-lg bg-[white] outline-none mt-[10px] focus:border-[#0000005a]"
            required
          />

          <button
            type="submit"
            class="w-full bg-[#047f58] text-white p-2 mt-[10px] rounded-lg font-semibold hover:bg-[#047f58df] transition"
            :class="
              loading
                ? 'bg-[#9d9d9d] cursor-not-allowed pointer-events-none'
                : ''
            "
          >
      ...
      <div class="features mt-[100px] text-left">
        <h2 class="text-[30px] font-semibold text-center mb-[80px]">
        ...
        <ul class="flex flex-col gap-6">
          <li>
            <div class="flex justify-start items-center gap-16">
              <p
                class="text-[50px] font-sans font-thin self-start leading-[1] w-[40px]"
              >
                1
              </p>
              <div>
      ...
      <!-- FAQ Section -->
      <div
        class="faq text-left mt-[140px] flex flex-col justify-center items-center"
      >
        <h2 class="text-[30px] font-semibold text-center mb-[40px]">
